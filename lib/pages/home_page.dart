...
import 'package:flutter_application_2/utils/my_tab.dart'; // Asegúrate de que el import es correcto
        ...
        body: Column(
          children: [
            ...
            Expanded(
              child: TabBarView(
                children: [
                  DonutTab(onAdd: addItemToCart), // Pasamos la función addItemToCart
                  BurgerTab(onAdd: addItemToCart),
                  SmoothieTab(onAdd: addItemToCart),
                  PancakeTab(onAdd: addItemToCart,),
